...
@Operation(
        summary = "Find tasks with weight cargo more than value.",
        description = "Find tasks with weight cargo more than value.",
        parameters = {
                @Parameter(
                        name = "weight",
                        ...
                        required = true,
                        in = ParameterIn.PATH,
                        schema = @Schema(type = "number", format = "number")
                )
        },
        responses = {
                @ApiResponse(
...
public @interface GetTaskByWeightCargoWhenMoreThanDocumentation {

package de.telran.transportcompanymanagementsystem.aspect;
...
public class LoggingAspect {
    @Pointcut("execution(public * de.telran.transportcompanymanagementsystem.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * de.telran.transportcompanymanagementsystem.service.*.*(..))")
